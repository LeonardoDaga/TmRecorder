...
{
    public partial class NTR_WebControl : UserControl, IResourceInterceptor
    {
        #region Fields
        ...
        public NTR_WebControl()
        {
            ...
            InitializeView(WebCore.CreateWebView(this.Size.Width, this.Size.Height, session));
        }

        public NTR_WebControl(Uri targetURL)
        {
            // Initialize the core and get a WebSession.
            WebSession session = InitializeCoreAndSession();
        ...
        internal NTR_WebControl(WebView view, int width, int height)
        {
            this.Width = width;
            this.Height = height;
