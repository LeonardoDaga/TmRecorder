...
{
    public partial class TMR_VariableDRColumn : DataGridViewColumn
    {
        public TMR_VariableDRColumn()
            : base(new TMR_VariableDRCell())
        {
            InitializeComponent();
        }

        public TMR_VariableDRColumn(IContainer container)
            : base(new TMR_VariableDRCell())
        {
            container.Add(this);
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            {
                if (value != null &&
                    !value.GetType().IsAssignableFrom(typeof(TMR_VariableDRCell)))
                {
                    throw new InvalidCastException("Must be a TMR_VariableDRCell");
                }
    ...
    #region TMR_VariableDRCell

    public class TMR_VariableDRCell : DataGridViewTextBoxCell
    {
        public short status = 2;
        public bool filterASIvalue = false;

        public TMR_VariableDRCell()
            : base()
        {
        }
            ...
            initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            TMR_VariableDREditingControl ctl =
                DataGridView.EditingControl as TMR_VariableDREditingControl;
        ...
        {
            TMR_VariableDRCell clone = (TMR_VariableDRCell)base.Clone();
            ...
            DataGridViewPaintParts paintParts)
        {
            try
            {
                ...
                TMR_VariableDRColumn dgc = (TMR_VariableDRColumn)(this.OwningColumn);
                ...
                PlayersDS.VarDataRow vdr = (PlayersDS.VarDataRow)dr.Row;

                if (this.OwningColumn.DataPropertyName != "ASI")
                {
                    decimal val_change = (decimal)vdr.Player_VDR_Change[OwningColumn.DataPropertyName];
                    if (val_change > 0)
                    {
                        // Dark green arrow
                ...
                {
                    int val_change = (int)vdr.Player_VDR_Change[OwningColumn.DataPropertyName];
                    if (val_change > 0)
                    {
                        // Dark green arrow
                        graphics.DrawImage(dgc.iconList2.Images[0], pt2);
        ...
        public override Type EditType
        {
            get
            {
                // Return the type of the editing contol that TMR_VariableDRCell uses.
                return typeof(TMR_VariableDREditingControl);
            }
        }
        ...
        public override Type ValueType
        {
            get
            {
                // Return the type of the value that TMR_VariableDRCell contains.
    ...
    class TMR_VariableDREditingControl : NumericUpDown, IDataGridViewEditingControl
    {
        DataGridView dataGridView;
        private bool valueChanged = false;
        int rowIndex;

        public TMR_VariableDREditingControl()
        {
        }
