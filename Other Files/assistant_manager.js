...
function update_tooltips() {
	...
	$("#shortpassing_amount").css({"width":final_shortpassing*2.5+"px","background-color":"#fc0","height":"7px", "border-radius": "2px", "border":"1px solid black"});
	$("#counter_amount").css({"width":final_counter*2.5+"px","background-color":"#fc0","height":"7px", "border-radius": "2px", "border":"1px solid black"});
	$("#through_amount").css({"width":final_through*2.5+"px","background-color":"#fc0","height":"7px", "border-radius": "2px", "border":"1px solid black"});
	$("#wing_amount").css({"width":final_wing*2.5+"px","background-color":"#fc0","height":"7px", "border-radius": "2px", "border":"1px solid black"});
	$("#longball_amount").css({"width":final_longball*2.5+"px","background-color":"#fc0","height":"7px", "border-radius": "2px", "border":"1px solid black"});
	...
	$("#heading_amount").css({"width":heading*2+"px","background-color":"#C00","height":"7px", "border-radius": "2px", "border":"1px solid black"});
	$("#longshots_amount").css({"width":longshots*2+"px","background-color":"#C00","height":"7px", "border-radius": "2px", "border":"1px solid black"});
	$("#finishing_amount").css({"width":finishing*2+"px","background-color":"#C00","height":"7px", "border-radius": "2px", "border":"1px solid black"});
}
...
function set_values(player_id) {
	...
	$("[player_id_attacking='"+player_id+"']").html("<div style='border-radius: 2px;border:1px solid black;margin-bottom:1px;height:7px;background-color:#CC0000;width:"+2*Math.round(attacking_players_own/(attacking_total)*100)/1+"px'></div>");
	$("[player_id_assist='"+player_id+"']").html("<div style='border-radius: 2px;border:1px solid black;margin-bottom:1px;height:7px;background-color:#FFCC00;width:"+2*Math.round(assist_players_own/(assist_total)*100)/1+"px'></div>");
	$("[player_id_defending='"+player_id+"']").html("<div style='border-radius: 2px;border:1px solid black; height:7px;background-color:#0099FF;width:"+2*Math.round(defending_players_own/(defending_total)*100)/1+"px'></div>");
