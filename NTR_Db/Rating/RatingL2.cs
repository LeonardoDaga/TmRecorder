...
namespace NTR_Db
{
    public class RatingL2: RatingFunction
    {
        private double _routineFactor = 0.004;

        public new eRatingFunctionType RatingFunctionType => eRatingFunctionType.RatingL2;
        ...
        public RatingL2(WeightMatrix recMatrix, WeightMatrix ratMatrix, WeightMatrix recLfMatrix, WeightMatrix adaMatrix, double rouFactor, string fileName)
        {
        ...
        public override void SettingInitialize()
        {
            ...
            Def("RatingFunctionType", eRatingFunctionType.RatingL2);
        }
    }
}
