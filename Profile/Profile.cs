...
{		
	...
	public abstract class Profile : IProfile
	{
        ...
        /// <summary>
        /// Set the actual section the next called function will refers for
        /// </summary>
        ...
        public object GetO(string entry)
        { return GetValue(_section, entry); }
        ...
        public string GetS(string entry)
        { return GetValue(_section, entry, ""); }
        ...
        public int GetI(string entry, int defaultVal)
        { return GetValue(_section, entry, defaultVal); }

        public int GetI(string entry)
        { return GetValue(_section, entry, 0); }
        ...
        public double GetD(string entry, double defaultVal)
        { return GetValue(_section, entry, defaultVal); }

        public double GetD(string entry)
        { return GetValue(_section, entry, 0.0); }
        ...
        public virtual float GetValue(string section, string entry, float defaultValue)
        {
            ...
            try
            {
                return float.Parse(Convert.ToString(value), CultureInfo.InvariantCulture);
            }
            catch
            {
                return 0f;
        ...
        public float GetF(string entry, float defaultVal)
        { return GetValue(_section, entry, defaultVal); }

        public float GetF(string entry)
        { return GetValue(_section, entry, 0f); }
        ...
        public bool GetB(string entry, bool defaultValue)
        { return GetValue(_section, entry, defaultValue); }

        public bool GetB(string entry)
        { return GetValue(_section, entry, false); }
