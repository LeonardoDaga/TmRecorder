...
{
    public partial class TMR_PlayerDSColumn : DataGridViewColumn
    {
        public TMR_PlayerDSColumn()
            : base(new TMR_PlayerDSCell())
        {
            InitializeComponent();
        }

        public TMR_PlayerDSColumn(IContainer container)
            : base(new TMR_PlayerDSCell())
        {
            container.Add(this);
        ...
        public override DataGridViewCell CellTemplate
        {
            ...
            {
                if (value != null &&
                    !value.GetType().IsAssignableFrom(typeof(TMR_PlayerDSCell)))
                {
                    throw new InvalidCastException("Must be a TMR_PlayerDSCell");
                }
    ...
    #region TMR_PlayerDSCell

    public class TMR_PlayerDSCell : DataGridViewTextBoxCell
    {
        public short status = 2;
        public bool filterASIvalue = false;

        public TMR_PlayerDSCell()
            : base()
        {
        }
            ...
            initialFormattedValue, DataGridViewCellStyle dataGridViewCellStyle)
        {
            ...
            TMR_PlayerDSEditingControl ctl =
                DataGridView.EditingControl as TMR_PlayerDSEditingControl;
        ...
        {
            TMR_PlayerDSCell clone = (TMR_PlayerDSCell)base.Clone();
            ...
            DataGridViewPaintParts paintParts)
        {
            try
            {
                ...
                TMR_PlayerDSColumn dgc = (TMR_PlayerDSColumn)(this.OwningColumn);
        ...
        public override Type EditType
        {
            get
            {
                // Return the type of the editing contol that TMR_PlayerDSCell uses.
                return typeof(TMR_PlayerDSEditingControl);
            }
        }
        ...
        public override Type ValueType
        {
            get
            {
                // Return the type of the value that TMR_PlayerDSCell contains.
    ...
    class TMR_PlayerDSEditingControl : NumericUpDown, IDataGridViewEditingControl
    {
        DataGridView dataGridView;
        private bool valueChanged = false;
        int rowIndex;

        public TMR_PlayerDSEditingControl()
        {
        }
