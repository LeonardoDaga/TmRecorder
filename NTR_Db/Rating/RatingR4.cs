    ...
    public class RatingR4 : RatingFunction
    {
        ...
        public override Rating ComputeRating(PlayerDataSkills playerData)
        {
            ...
            var positionsAll = new double[][] {
                new double [] {0, 2, 2, 1, 3, 3, 2, 4, 4, 3, 4, 4, 4},    // D C
                new double [] {2, 0, 1, 3, 1, 2, 4, 2, 3, 4, 3, 4, 4},    // D L
                new double [] {2, 1, 0, 3, 2, 1, 4, 3, 2, 4, 4, 3, 4},    // D R
                new double [] {1, 3, 3, 0, 2, 2, 1, 3, 3, 2, 4, 4, 3},    // DM C
                new double [] {3, 1, 2, 2, 0, 1, 3, 1, 2, 4, 2, 3, 4},    // DM L
                new double [] {3, 2, 1, 2, 1, 0, 3, 2, 1, 4, 3, 2, 4},    // DM R
                new double [] {2, 4, 4, 1, 3, 3, 0, 2, 2, 1, 3, 3, 2},    // M C
                new double [] {4, 2, 3, 3, 1, 2, 2, 0, 1, 3, 1, 2, 4},    // M L
                new double [] {4, 3, 2, 3, 2, 1, 2, 1, 0, 3, 2, 1, 4},    // M R
                new double [] {3, 4, 4, 2, 4, 4, 1, 3, 3, 0, 2, 2, 1},    // OM C
                new double [] {4, 3, 4, 4, 2, 3, 3, 1, 2, 2, 0, 1, 3},    // OM L
                new double [] {4, 4, 3, 4, 3, 2, 3, 2, 1, 2, 1, 0, 3},    // OM R
                new double [] {4, 4, 4, 3, 4, 4, 2, 4, 4, 1, 3, 3, 0 }    // F C
                };	
