...
namespace FieldFormationControl
{
    public partial class RotFormationControl : UserControl
    {
        ...
        private void Y_ShowGoalKee(Formation form)
        {
            ...
            CreatePlayer(GK, Position.GetPosition(Pos.GK, true, false), ref fp[P.Y_GK]);
        }
        ...
        private void Y_ShowFrwdAttack(Formation form)
        {
            ...
            CreatePlayer(CL, Position.GetPosition(Pos.FCL, true, !C.visible), ref fp[P.Y_FCL]);
            CreatePlayer(C, Position.GetPosition(Pos.FC, true, !C.visible), ref fp[P.Y_FC]);
            CreatePlayer(CR, Position.GetPosition(Pos.FCR, true, !C.visible), ref fp[P.Y_FCR]);
        }
        ...
        private void Y_ShowOffense(Formation form)
        {
            ...
            CreatePlayer(L, Position.GetPosition(Pos.OML, true, !C.visible), ref fp[P.Y_OML]);
            CreatePlayer(CL, Position.GetPosition(Pos.OMCL, true, !C.visible), ref fp[P.Y_OMCL]);
            CreatePlayer(C, Position.GetPosition(Pos.OMC, true, !C.visible), ref fp[P.Y_OMC]);
            CreatePlayer(CR, Position.GetPosition(Pos.OMCR, true, !C.visible), ref fp[P.Y_OMCR]);
            CreatePlayer(R, Position.GetPosition(Pos.OMR, true, !C.visible), ref fp[P.Y_OMR]);
        }
        ...
        private void Y_ShowMidfiel(Formation form)
        {
            ...
            CreatePlayer(L, Position.GetPosition(Pos.ML, true, !C.visible), ref fp[P.Y_ML]);
            CreatePlayer(CL, Position.GetPosition(Pos.MCL, true, !C.visible), ref fp[P.Y_MCL]);
            CreatePlayer(C, Position.GetPosition(Pos.MC, true, !C.visible), ref fp[P.Y_MC]);
            CreatePlayer(CR, Position.GetPosition(Pos.MCR, true, !C.visible), ref fp[P.Y_MCR]);
            CreatePlayer(R, Position.GetPosition(Pos.MR, true, !C.visible), ref fp[P.Y_MR]);
        }
        ...
        private void Y_ShowMidDefn(Formation form)
        {
            ...
            CreatePlayer(L, Position.GetPosition(Pos.DML, true, !C.visible), ref fp[P.Y_DML]);
            CreatePlayer(CL, Position.GetPosition(Pos.DMCL, true, !C.visible), ref fp[P.Y_DMCL]);
            CreatePlayer(C, Position.GetPosition(Pos.DMC, true, !C.visible), ref fp[P.Y_DMC]);
            CreatePlayer(CR, Position.GetPosition(Pos.DMCR, true, !C.visible), ref fp[P.Y_DMCR]);
            CreatePlayer(R, Position.GetPosition(Pos.DMR, true, !C.visible), ref fp[P.Y_DMR]);
        }
        ...
        private void Y_ShowDefense(Formation form)
        {
            ...
            CreatePlayer(R, Position.GetPosition(Pos.DR, true, !C.visible), ref fp[P.Y_DR]);
        }
        ...
        {
            Player GK = form.players[Pos.GK];
            CreatePlayer(GK, Position.GetPosition(Pos.GK, false, false), ref fp[P.O_GK]);
        }
        ...
        private void O_ShowFrwdAttack(Formation form)
        {
            ...
            CreatePlayer(CL, Position.GetPosition(Pos.FCL, false, !C.visible), ref fp[P.O_FCL]);
            CreatePlayer(C, Position.GetPosition(Pos.FC, false, !C.visible), ref fp[P.O_FC]);
            CreatePlayer(CR, Position.GetPosition(Pos.FCR, false, !C.visible), ref fp[P.O_FCR]);
        }
        ...
        private void O_ShowOffense(Formation form)
        {
            ...
            CreatePlayer(L, Position.GetPosition(Pos.OML, false, !C.visible), ref fp[P.O_OML]);
            CreatePlayer(CL, Position.GetPosition(Pos.OMCL, false, !C.visible), ref fp[P.O_OMCL]);
            CreatePlayer(C, Position.GetPosition(Pos.OMC, false, !C.visible), ref fp[P.O_OMC]);
            CreatePlayer(CR, Position.GetPosition(Pos.OMCR, false, !C.visible), ref fp[P.O_OMCR]);
            CreatePlayer(R, Position.GetPosition(Pos.OMR, false, !C.visible), ref fp[P.O_OMR]);
        }
        ...
        private void O_ShowMidfiel(Formation form)
        {
            ...
            CreatePlayer(L, Position.GetPosition(Pos.ML, false, !C.visible), ref fp[P.O_ML]);
            CreatePlayer(CL, Position.GetPosition(Pos.MCL, false, !C.visible), ref fp[P.O_MCL]);
            CreatePlayer(C, Position.GetPosition(Pos.MC, false, !C.visible), ref fp[P.O_MC]);
            CreatePlayer(CR, Position.GetPosition(Pos.MCR, false, !C.visible), ref fp[P.O_MCR]);
            CreatePlayer(R, Position.GetPosition(Pos.MR, false, !C.visible), ref fp[P.O_MR]);
        }
        ...
        private void O_ShowMidDefn(Formation form)
        {
            ...
            CreatePlayer(L, Position.GetPosition(Pos.DML, false, !C.visible), ref fp[P.O_DML]);
            CreatePlayer(CL, Position.GetPosition(Pos.DMCL, false, !C.visible), ref fp[P.O_DMCL]);
            CreatePlayer(C, Position.GetPosition(Pos.DMC, false, !C.visible), ref fp[P.O_DMC]);
            CreatePlayer(CR, Position.GetPosition(Pos.DMCR, false, !C.visible), ref fp[P.O_DMCR]);
            CreatePlayer(R, Position.GetPosition(Pos.DMR, false, !C.visible), ref fp[P.O_DMR]);
        }
        ...
        private void O_ShowDefense(Formation form)
        {
            ...
            CreatePlayer(L, Position.GetPosition(Pos.DL, false, !C.visible), ref fp[P.O_DL]);
            CreatePlayer(CL, Position.GetPosition(Pos.DCL, false, !C.visible), ref fp[P.O_DCL]);
            CreatePlayer(C, Position.GetPosition(Pos.DC, false, !C.visible), ref fp[P.O_DC]);
            CreatePlayer(CR, Position.GetPosition(Pos.DCR, false, !C.visible), ref fp[P.O_DCR]);
            CreatePlayer(R, Position.GetPosition(Pos.DR, false, !C.visible), ref fp[P.O_DR]);
        }
